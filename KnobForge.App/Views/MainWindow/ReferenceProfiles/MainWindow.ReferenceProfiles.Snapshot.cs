    ...
    public partial class MainWindow
    {
            ...
            bool includeLightingEnvironmentShadowAndLights = false)
        {
            ...
            if (includeLightingEnvironmentShadowAndLights)
            {
                ...
                snapshot.BloomRadius = project.BloomRadius;
                snapshot.BloomTintR = project.BloomTintR;
                snapshot.BloomTintG = project.BloomTintG;
                snapshot.BloomTintB = project.BloomTintB;
                snapshot.GlareRotationDegrees = project.GlareRotationDegrees;
                snapshot.BloomCompositeIntensity = project.BloomCompositeIntensity;
                snapshot.ReflectionStrength = project.ReflectionStrength;
                snapshot.ReflectionFresnelBias = project.ReflectionFresnelBias;
                snapshot.ClearCoatReflectionStrength = project.ClearCoatReflectionStrength;
                snapshot.ReflectionOnlyPreview = project.ReflectionOnlyPreview;
                ...
                snapshot.EnvironmentBloomKnee = project.EnvironmentBloomKnee;
                snapshot.EnvironmentHdriPath = project.EnvironmentHdriPath;
                snapshot.EnvironmentHdriBlend = project.EnvironmentHdriBlend;
                snapshot.EnvironmentHdriRotationDegrees = project.EnvironmentHdriRotationDegrees;
            ...
            CollarNode? collar = null)
        {
            if (snapshot.HasLightingEnvironmentShadowSnapshot)
            {
                ...
                project.BloomRadius = snapshot.BloomRadius;
                project.BloomTintR = snapshot.BloomTintR;
                project.BloomTintG = snapshot.BloomTintG;
                project.BloomTintB = snapshot.BloomTintB;
                project.GlareRotationDegrees = snapshot.GlareRotationDegrees;
                project.BloomCompositeIntensity = snapshot.BloomCompositeIntensity;
                project.ReflectionStrength = snapshot.ReflectionStrength;
                project.ReflectionFresnelBias = snapshot.ReflectionFresnelBias;
                project.ClearCoatReflectionStrength = snapshot.ClearCoatReflectionStrength;
                project.ReflectionOnlyPreview = snapshot.ReflectionOnlyPreview;
                ...
                project.EnvironmentBloomKnee = snapshot.EnvironmentBloomKnee;
                project.EnvironmentHdriPath = snapshot.EnvironmentHdriPath;
                project.EnvironmentHdriBlend = snapshot.EnvironmentHdriBlend;
                project.EnvironmentHdriRotationDegrees = snapshot.EnvironmentHdriRotationDegrees;
